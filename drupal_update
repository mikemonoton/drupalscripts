...
# Das Script kann unter "/sbin/drupal_update_script" abgelegt werden und wird im Verzeichniss des Drupal DocRoot aufgerufen
...
echo "Seite wird in den Wartungsmodus gesetzt"
